...
export class CustomerUpdateComponent implements OnInit {
  ...
  updateForm(customer: ICustomer) {
    this.editForm.patchValue({
      ...
      createdAt: customer.createdAt != null ? customer.createdAt.format(DATE_TIME_FORMAT) : null,
      lastUpdatedBy: customer.lastUpdatedBy,
      lastUpdatedAt: customer.lastUpdatedAt != null ? customer.lastUpdatedAt.format(DATE_TIME_FORMAT) : null
    });
  }
